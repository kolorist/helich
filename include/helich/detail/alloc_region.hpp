...
size alloc_region_dbginfo_extractor<t_alloc_region>::extract_info(voidptr i_allocRegion, debug_memory_block* i_memBlocks,
		const u32 i_maxSize, u32& o_numBlocks)
{
	...
	return allocRegion->p_used_bytes;
}
